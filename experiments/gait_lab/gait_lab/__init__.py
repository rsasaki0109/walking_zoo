...
locomotion_ros2 itself is *not* a gait research stack — it is the runtime/safety/
...
This mirrors the locomotion_ros2 thesis: a gait algorithm is just another command
