#ifndef LOCOMOTION_ROS2_BT__NAV2_RECOVERY_NODES_HPP_
#define LOCOMOTION_ROS2_BT__NAV2_RECOVERY_NODES_HPP_
...
// sets, subscribes to /locomotion_ros2/state on its own callback group, and reports
...
private:
  void stateCallback(locomotion_ros2_msgs::msg::WalkingState::SharedPtr msg);
...
// It calls /locomotion_ros2/clear_fault through the very same machinery every Nav2
...
class ClearWalkingFaultBtNode
  : public nav2_behavior_tree::BtServiceNode<locomotion_ros2_msgs::srv::ClearFault>
{
public:
  ...
  BT::NodeStatus on_completion(
    std::shared_ptr<locomotion_ros2_msgs::srv::ClearFault::Response> response) override;
  static BT::PortsList providedPorts();
};

}  // namespace locomotion_ros2_bt

#endif  // LOCOMOTION_ROS2_BT__NAV2_RECOVERY_NODES_HPP_
