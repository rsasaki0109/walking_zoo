#!/usr/bin/env python3
"""Live MuJoCo Unitree G1 gait demo driven by locomotion_ros2 ROS2 topics.

This is an optional visual demo. It does not participate in the runtime safety
path and it does not add MuJoCo as a dependency of locomotion_ros2 itself.
"""
    ...
    def __init__(self, menagerie_path, width=960, height=540):
        ...
        if not scene_path.exists():
            raise RuntimeError(
                ...
                "menagerie_path / LOCOMOTION_ROS2_MENAGERIE_PATH:\n"
...
class MujocoG1GaitDemo(Node):
    def __init__(self):
        super().__init__("locomotion_ros2_mujoco_g1_gait_demo")
        self.declare_parameter(
            "menagerie_path",
            os.environ.get("LOCOMOTION_ROS2_MENAGERIE_PATH", "/tmp/locomotion_ros2_mujoco_menagerie"),
        )
        self.declare_parameter("output_dir", "/tmp/locomotion_ros2_mujoco_g1_demo")
        ...
        self.create_subscription(TwistStamped, "/locomotion_ros2/cmd_vel", self.on_twist_stamped, 10)
        self.create_subscription(Twist, "/cmd_vel", self.on_twist, 10)
        self.create_subscription(SemanticAction, "/locomotion_ros2/semantic_action", self.on_semantic, 10)
    ...
    def on_twist_stamped(self, msg):
        self.update_from_twist(msg.twist, "locomotion_ros2/cmd_vel")
