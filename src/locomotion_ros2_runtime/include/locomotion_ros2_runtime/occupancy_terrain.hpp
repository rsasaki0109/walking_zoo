#ifndef LOCOMOTION_ROS2_RUNTIME__OCCUPANCY_TERRAIN_HPP_
#define LOCOMOTION_ROS2_RUNTIME__OCCUPANCY_TERRAIN_HPP_
...
#endif  // LOCOMOTION_ROS2_RUNTIME__OCCUPANCY_TERRAIN_HPP_
