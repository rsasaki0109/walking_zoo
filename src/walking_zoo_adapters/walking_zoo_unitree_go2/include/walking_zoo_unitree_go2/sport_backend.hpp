#ifndef WALKING_ZOO_UNITREE_GO2__SPORT_BACKEND_HPP_
#define WALKING_ZOO_UNITREE_GO2__SPORT_BACKEND_HPP_
...
// (compiled only when WALKING_ZOO_WITH_UNITREE_SDK2 is set). This mirrors the
...
#endif  // WALKING_ZOO_UNITREE_GO2__SPORT_BACKEND_HPP_
