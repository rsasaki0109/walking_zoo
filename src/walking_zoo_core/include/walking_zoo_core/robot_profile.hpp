#ifndef WALKING_ZOO_CORE__ROBOT_PROFILE_HPP_
#define WALKING_ZOO_CORE__ROBOT_PROFILE_HPP_

#include <string>

#include "walking_zoo_msgs/msg/robot_profile.hpp"
...
struct RobotProfile
{
  ...
  std::string adapter_plugin{"walking_zoo_mock_adapter/MockWalkingAdapter"};
  ...
  walking_zoo_msgs::msg::RobotProfile to_msg() const;
};
...
#endif  // WALKING_ZOO_CORE__ROBOT_PROFILE_HPP_
